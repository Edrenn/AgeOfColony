...
namespace AgeOfColony.Controllers
{
    public class RareResourcesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "PrimaryKey,Name,ImgUrl")] RareResource rareResource)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "PrimaryKey,Name,ImgUrl")] RareResource rareResource)
        {
            if (ModelState.IsValid)
            {
